...
var (
	...
	ErrStateHashMismatch           = errors.Register(ModuleName, 1517, "checkpoint state hash mismatch")
	ErrPreviousStateBroken         = errors.Register(ModuleName, 1518, "previous checkpoint state hash does not match latest known state")
	ErrConsensusProofRequired      = errors.Register(ModuleName, 1519, "consensus proof is required")
	ErrConsensusProofInvalid       = errors.Register(ModuleName, 1520, "consensus proof is invalid")
	ErrKeyEpochRollback            = errors.Register(ModuleName, 1521, "hysteresis key epoch rollback")
)
